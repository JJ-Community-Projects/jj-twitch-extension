...
const useBackendHook = () => {
  ...
  const enableOverviewQuery = () => {
    return isAuthInit() && (community() || charities())
  }
...
export const OverlayBackendProvider: ParentComponent = (props) => {
...
export const useOverlayBackend = () => useContext(BackendContext)!
